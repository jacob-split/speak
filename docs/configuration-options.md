...
| `SPEAK_PRODUCT_PAGE_URL` | docs/brand QA env | `https://files.split-llc.com/speak/` | Published product/docs URL fetched by `qa:brand-marketing -- --published` to verify the current public showcase. |
